...
export default function BtnLanguage() {
    ...
    return (
        <div
            className="fixed bottom-4 right-4 flex flex-col items-center justify-center w-24 gap-2 p-2 bg-gray-100 rounded-lg shadow-lg cursor-pointer hover:bg-gray-200 hover:scale-105 transition duration-200"
